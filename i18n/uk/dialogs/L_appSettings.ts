export default {
  ...
  appOptions: {
    ...
    disableQuickSearchCategoryPrecheck: {
      title: 'Не перевіряйте фільтр категорії',
      description: 'Зазвичай категорії включені в швидкий пошук. Увімкнення цього параметра змінює цю поведінку.',
      tags: 'фільтр категорії, область пошуку, включити категорії, фільтр за замовчуванням',
    },
    disableSpellCheck: {
